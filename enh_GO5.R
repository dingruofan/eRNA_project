...
for(i in tissues){
  assign(paste(i,"_enh",sep=""),enh_all[enh_all$tissue==i&enh_all$is_spe=="other",])
  print(i)
}
#从rGREAT官网建立任务:
for(j in tissues){
...
#选择其中Freq>=7的：
all_tissue_GO_common<-all_tissue_tb_GO[all_tissue_tb_GO$Freq>=9,"name",drop=FALSE]
...
#做图：
png_path="/media/ding/000B49000006264C/eRNA_project/figure/GO_other_enh_common.png"
